...
void asdRadixSort(std::vector<unsigned int>& v)
{
    ...
    asdCountingSort(v.begin(), v.end(), m.begin(), [](unsigned int i) { return (i >> (8*0)) & 255  ; }, 255);
    asdCountingSort(m.begin(), m.end(), v.begin(), [](unsigned int i) { return (i >> (8*1)) & 255  ; }, 255);
    asdCountingSort(v.begin(), v.end(), m.begin(), [](unsigned int i) { return (i >> (8*2)) & 255  ; }, 255);
    asdCountingSort(m.begin(), m.end(), v.begin(), [](unsigned int i) { return (i >> (8*3)) & 255  ; }, 255);
